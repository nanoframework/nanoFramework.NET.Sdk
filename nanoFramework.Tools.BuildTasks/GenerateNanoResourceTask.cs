...
namespace nanoFramework.Tools
{
    ...
    {
        /// <summary>
        /// Magic + version guarding the cache format. Bump <see cref="CacheVersion"/>
        ...
        /// <see cref="BinaryReader"/> ready for the derived content, or null when the
    ...
    internal sealed class ResGenDependencies : StateFileBase
    {
        ...
        /// <summary>
        /// Writes the cached .resx dependency information (see <see cref="StateFileBase"/>).
        /// </summary>
