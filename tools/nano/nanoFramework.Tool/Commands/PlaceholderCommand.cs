...
/// <summary><c>dotnet nano deploy</c> — placeholder (build Deploy target + device comms).</summary>
public sealed class DeployCommand : PlaceholderCommand
{
    protected override string Verb => "deploy";
}
