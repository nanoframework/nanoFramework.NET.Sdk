...
internal sealed class Options
{
    ...
    // Parsed but no longer emitted: the SDK reference is versionless (the version
    // is pinned via global.json msbuild-sdks). Kept for CLI back-compat.
    ...
    // Default to .csproj: a normal run produces Foo.csproj and deletes Foo.nfproj.
